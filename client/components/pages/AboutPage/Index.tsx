...
export default function AboutPage() {
  return (
    <main className="bg-[#fbfaf7]">
      <section className="bg-[#0B2D4D] px-8 py-24 text-white">
        <p className="mb-4 text-sm uppercase tracking-[0.3em] text-[#D4AF37]">Về Scentora</p>
        <h1 className="max-w-4xl text-5xl font-bold leading-tight md:text-6xl">Thắp sáng không gian, lan tỏa yêu thương</h1>
      ...
      <section className="grid gap-10 px-8 py-20 md:grid-cols-3">
        {values.map((value) => (
      ...
      <section className="px-8 pb-20">
        <div className="rounded-[36px] bg-white p-10 shadow-sm md:p-14">
          <h2 className="mb-5 text-4xl font-bold text-[#0B2D4D]">Câu chuyện thương hiệu</h2>
          <p className="max-w-4xl text-lg leading-9 text-gray-700">
